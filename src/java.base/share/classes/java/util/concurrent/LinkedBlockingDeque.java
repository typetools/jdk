...
public class LinkedBlockingDeque<E extends Object>
     ...
     */
    public @PolyGrowShrink @PolyNonEmpty Iterator<E> descendingIterator(@PolyGrowShrink @PolyNonEmpty LinkedBlockingDeque this) {
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean retainAll(@GuardSatisfied @Shrinkable LinkedBlockingDeque this, Collection<? extends @NonNull @UnknownSignedness Object> c) {
        Objects.requireNonNull(c);
        return bulkRemove(e -> !c.contains(e));
    }
