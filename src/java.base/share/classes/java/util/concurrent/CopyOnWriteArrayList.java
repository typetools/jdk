...
public class CopyOnWriteArrayList<E>
     ...
     * @see #remove(Object)
     */
    public boolean retainAll(@GuardSatisfied @Shrinkable CopyOnWriteArrayList this, Collection<? extends @NonNull @UnknownSignedness Object> c) {
        Objects.requireNonNull(c);
        return bulkRemove(e -> !c.contains(e));
    }
     ...
     * @since 1.8
     */
    public @PolyGrowShrink @PolyNonEmpty Spliterator<E> spliterator(@PolyGrowShrink @PolyNonEmpty CopyOnWriteArrayList<E> this) {
